...
module.exports = class extends Generator {
  ...
  constructor(args, opts) {
    ...
    // * name: the service name. If not set, the user will be prompted.
  ...
  prompting() {
    // Prompts the user for the service name and domain unless they have been
    // set as an option
    let allPrompts = [{
      type: 'input',
      name: 'name',
